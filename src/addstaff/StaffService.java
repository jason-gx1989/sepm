...
public class StaffService {
    ...
    public int createStaff(String fullName, String password, String mobileNumber, String email, String preferredName, String homeAddress){

        Staff staff = new Staff();
        staff.setId(Math.abs ((int) System.currentTimeMillis()));
